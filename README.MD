...
- Change configurations
  ...
  - `widget.windows.mica.toplevel-backdrop` set to `2` (Windows)
- Restart Firefox!
...
- 以下布尔值切换为 `false`
  - `sidebar.animation.enabled`
  - _macOS:_ `widget.macos.native-context-menus` (可选项)
- `widget.windows.mica.toplevel-backdrop` 设为 `2` (Windows)
- 重启火狐
